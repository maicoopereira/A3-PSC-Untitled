...
> O programa consiste em uma aplicacao simples de gerenciamento de estoque. O programa apresenta flags de quantidade e alerta de validade. Alem de um sistema de busca de produtos por qualquer informação, como nome, id, etc.
> Ele utiliza banco mySQL alocado na porta 3306 do localhost. Antes de utilizar, se necessario, atualize com suas credenciais locais.
